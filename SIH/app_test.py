...
st.markdown("""
    ...
    /* ===== Sidebar Styling ===== */
    section[data-testid="stSidebar"], div[data-testid="stSidebar"], aside[data-testid="stSidebar"], nav[aria-label="Sidebar"] {
    ...
    section[data-testid="stSidebar"] *, div[data-testid="stSidebar"] *, aside[data-testid="stSidebar"] *, nav[aria-label="Sidebar"] * {
        color: #2e7d32 !important; /* green sidebar text */
        font-weight: 600;
    }
    ...
    /* ===== Header / Hero ===== */
    .hero {
        background: linear-gradient(135deg, rgba(46,125,50,0.9), rgba(3,169,244,0.85));
        border-radius: 18px;
        padding: 30px 25px;
        color: #ffffff;
    ...
    .stButton>button {
        ...
        border: 2px solid rgba(13, 71, 161, 0.9) !important;
        border-radius: 10px;
        padding: 10px 18px;
        font-weight: 700;
    ...
    .stButton>button:hover {
        ...
        box-shadow: 0 16px 32px rgba(13, 71, 161, 0.25);
        filter: drop-shadow(0 0 10px rgba(30, 136, 229, 0.45));
    }
...
translations = {
    ...
    'hi': {
        ...
        'page_home': "होम", 'page_crop_recommendation': "फसल सिफारिश", 'page_yield_prediction': "उपज भविष्यवाणी", 'page_crop_calendar': "फसल कैलेंडर", 'page_weather_report': "मौसम रिपोर्ट", 'page_leaf_disease_prediction': "पत्ती रोग की भविष्यवाणी", 'page_translator': "अनुवादक", 'page_ai_chatbot': "एआई चैटबॉट", 'page_profile': "प्रोफ़ाइल", 'page_logs': "लॉग", 'page_community_forum': "सामुदायिक मंच",
    ...
    'ml': {
        ...
        'page_home': "ഹോം", 'page_crop_recommendation': "വിള ശുപാർശ", 'page_yield_prediction': "വിളവ് പ്രവചനം", 'page_crop_calendar': "വിള കലണ്ടർ", 'page_weather_report': "കാലാവസ്ഥാ റിപ്പോർട്ട്", 'page_leaf_disease_prediction': "ഇലരോഗ നിർണ്ണയം", 'page_translator': "പരിഭാഷകൻ", 'page_ai_chatbot': "AI ചാറ്റ്ബോട്ട്", 'page_profile': "പ്രൊഫൈൽ", 'page_logs': "ലോഗുകൾ", 'page_community_forum': "കമ്മ്യൂണിറ്റി ഫോറം",
    ...
    'ta': {
        ...
        'page_home': "முகப்பு", 'page_crop_recommendation': "பயிர் பரிந்துரை", 'page_yield_prediction': "விளைச்சல் கணிப்பு", 'page_crop_calendar': "பயிர் காலண்டர்", 'page_weather_report': "வானிலை அறிக்கை", 'page_leaf_disease_prediction': "இலை நோய் கணிப்பு", 'page_translator': "மொழிபெயர்ப்பாளர்", 'page_ai_chatbot': "AI அரட்டைப்பெட்டி", 'page_profile': "சுயவிவரம்", 'page_logs': "பதிவுகள்", 'page_community_forum': "சமூக மன்றம்",
    ...
    'te': {
        ...
        'page_home': "హోమ్", 'page_crop_recommendation': "పంట సిఫార్సు", 'page_yield_prediction': "దిగుబడి అంచనా", 'page_crop_calendar': "పంట క్యాలెండర్", 'page_weather_report': "వాతావరణ నివేదిక", 'page_leaf_disease_prediction': "ఆకు వ్యాధి πρόβλεψη", 'page_translator': "అనువాదకుడు", 'page_ai_chatbot': "AI చాట్‌బాట్", 'page_profile': "ప్రొఫైల్", 'page_logs': "లాగ్‌లు", 'page_community_forum': "కమ్యూనిటీ ఫోరమ్",
    ...
    'bn': {
        ...
        'page_home': "হোম", 'page_crop_recommendation': "ফসল সুপারিশ", 'page_yield_prediction': "উৎপাদন ভবিষ্যদ্বাণী", 'page_crop_calendar': "ফসল ক্যালেন্ডার", 'page_weather_report': "আবহাওয়া রিপোর্ট", 'page_leaf_disease_prediction': "পাতা রোগ ভবিষ্যদ্বাণী", 'page_translator': "অনুবাদক", 'page_ai_chatbot': "AI চ্যাটবট", 'page_profile': "প্রোফাইল", 'page_logs': "লগ", 'page_community_forum': "কমিউনিটি ফোরাম",
    ...
    'pa': {
        ...
        'page_home': "ਘਰ", 'page_crop_recommendation': "ਫਸਲ ਸਿਫਾਰਸ਼", 'page_yield_prediction': "ਉਪਜ ਭਵਿੱਖਬਾਣੀ", 'page_crop_calendar': "ਫਸਲ ਕੈਲੰਡਰ", 'page_weather_report': "ਮੌਸਮ ਰਿਪੋਰਟ", 'page_leaf_disease_prediction': "ਪੱਤਾ ਬਿਮਾਰੀ ਭਵਿੱਖਬਾਣੀ", 'page_translator': "ਅਨੁਵਾਦਕ", 'page_ai_chatbot': "AI ਚੈਟਬੋਟ", 'page_profile': "ਪ੍ਰੋਫਾਈਲ", 'page_logs': "ਲੌਗ", 'page_community_forum': "ਕਮਿਊਨਿਟੀ ਫੋਰਮ",
    ...
    'mr': {
        ...
        'page_home': "घर", 'page_crop_recommendation': "पिक शिफारस", 'page_yield_prediction': "उत्पादन अंदाज", 'page_crop_calendar': "पिक कॅलेंडर", 'page_weather_report': "हवामान अहवाल", 'page_leaf_disease_prediction': "पान रोग अंदाज", 'page_translator': "भाषांतरकार", 'page_ai_chatbot': "AI चॅटबॉट", 'page_profile': "प्रोफाइल", 'page_logs': "लॉग", 'page_community_forum': "समुदाय मंच",
...
if not st.session_state.get('authenticated', False):
    ...
    if nav_param == 'page_ai_chatbot':
        st.session_state['show_landing'] = False
        st.session_state['_requested_page'] = 'page_ai_chatbot'
        ...
        <div class='page-block'>
            ...
            <div class='contact-grid'>
                <div class='contact-item'>
                    ...
                    <h4>Email</h4>
                    <p><a href='mailto:agrisakhi@gmail.com'>agrisakhi@gmail.com</a></p>
                </div>
                <div class='contact-item'>
                    <div class='contact-icon'>📱</div>
                    <h4>Phone</h4>
...
# =====================================================================================
    ...
    def _apply_requested_page():
        page_keymap = {
            ...
            "Translator": "page_translator", "AI Chatbot": "page_ai_chatbot", "Community Forum": "page_community_forum"
        }
    ...
    with st.sidebar:
        ...
        PAGES_KEYS = {
            ...
            'page_translator': "Translator", 'page_ai_chatbot': "AI Chatbot", 'page_community_forum': "Community Forum"
        }
    ...
    # Initialize chatbot section state
    if 'show_chatbot_section' not in st.session_state:
        st.session_state['show_chatbot_section'] = False

    # --- FLOATING CHATBOT SECTION (Available on all pages) ---
    st.divider()
    
    # Load ICON.jpg for the chatbot header
    try:
        with open("ICON.jpg", "rb") as img_file:
            chatbot_icon_base64 = base64.b64encode(img_file.read()).decode('utf-8')
        
        # Create expander with simple text label
        with st.expander(f"💬 {t('page_ai_chatbot')}", expanded=st.session_state.get('show_chatbot_section', False)):
            # Display the icon with title inside the expander using HTML
            st.markdown(f"""
            <div style="display: flex; align-items: center; gap: 12px; font-size: 18px; font-weight: 600; margin-bottom: 20px;">
                <img src="data:image/jpeg;base64,{chatbot_icon_base64}" style="width: 50px; height: 50px; object-fit: contain; border-radius: 8px;">
                <span>{t('page_ai_chatbot')}</span>
            </div>
            """, unsafe_allow_html=True)
            
            st.markdown(t('ai_chatbot_assistant_header'))
            st.markdown(t('ai_chatbot_assistant_desc'))
            
            # Embedded chatbot iframe
            chatbot_code = """
            <iframe src="https://chat.cxgenie.ai?aid=71a90137-4bcc-490a-bdce-5d0d8c894d5b&lang=en"
                style="width: 100%; height: 600px; border: none; border-radius: 10px;">
            </iframe>
            """
            st.components.v1.html(chatbot_code, height=620)
    ...
    elif page == "page_ai_chatbot":
        st.header(t('ai_chatbot_header'))
        st.markdown("---")
        st.subheader("🌐 Extended Chatbot Interface")
        st.markdown("Get detailed answers to your farming questions directly. Ask anything about crops, weather, soil, pests, and more!")
        st.info("💡 **Tip:** Use this chatbot interface below to get answers to your farming questions.")
        
        st.divider()
        
        # Embedded chatbot iframe as full interface
        chatbot_code = """
        <iframe src="https://chat.cxgenie.ai?aid=71a90137-4bcc-490a-bdce-5d0d8c894d5b&lang=en"
            style="width: 100%; height: 700px; border: none; border-radius: 10px;">
        </iframe>
        """
        st.components.v1.html(chatbot_code, height=720)
